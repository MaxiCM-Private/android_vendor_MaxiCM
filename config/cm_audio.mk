...
ALARM_PATH := vendor/MaxiCM/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/MaxiCM/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/MaxiCM/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/MaxiCM/prebuilt/common/media/audio/ui
